...
public class Sudoku {
    ...
    private boolean canBePlaced(int row, int col, int val){
        if(subgridHasVal[row/3][col/3][val] || rowHasVal[row][val] || colHasVal[col][val]){
            return false;
        }
        return true;
    }
